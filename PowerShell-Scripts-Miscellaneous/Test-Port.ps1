...
$result = @()
# SQL Instances ports
$result += @("Server01","Server02") | Test-Port -port 1433 -TCP

# SQL Browser port - UDP 1434
$result += @("Server01","Server02") | Test-Port -port 1434 -UDP

# PS Remoting Ports
$result += @("Server01","Server02") | Test-Port -port @(5985,5986) -TCP

# Other ports
$result += @("Server01","Server02") | Test-Port -port @(135,139,445) -TCP

$result | ft -AutoSize
$result | Sort-Object -Property Server, Port | ft -AutoSize
#>