...
import SmaAlertPackage.AlertClasses.SmaNonAgDbBackupIssueAlert as sma

# get Script Name
script_name = os.path.basename(__file__)

parser = argparse.ArgumentParser(description="Script to raise backup issue alert", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
