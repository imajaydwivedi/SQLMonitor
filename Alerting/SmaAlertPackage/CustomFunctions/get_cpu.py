...
set @_params = N'@cpu_warning_pct decimal(20,2), @cpu_critical_pct decimal(20,2)';
...
where 1=1
and vih.collection_time >= dateadd(minute,-15,getdate())
group by srv_name
...
exec sp_executesql @_sql, @_params, @_cpu_warning_pct, @_cpu_critical_pct;
"""
    if verbose:
