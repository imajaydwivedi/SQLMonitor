-- SCH-BlitzIndex_Mode0-Partitioning.sql
IF DB_NAME() = 'master'
...
set @table_name = 'dbo.BlitzIndex_Mode0';
...
if		( @cx_name is not null and @is_partitioned = 1 and @data_space_id <= 1 )
	or	( @cx_name is not null and @cx_name <> 'pk_BlitzIndex_Mode0' )
begin
...
begin
	...
	set @cx_name = 'pk_BlitzIndex_Mode0';
